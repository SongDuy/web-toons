...
const Suggestsubscribed = () => {
  ...
  return (
    <div className="mt-[30px] grid xs:grid-cols-1 lg:grid-cols-2 xs:px-[20px] sm:px-[40px] md:px-[80px] lg:px-[120px] xl:px-[160px] 2xl:px-[200px] 3xl:px-[240px]">
          ...
          <div className="w-full flex p-5">
            <div className="w-full h-full">
              {filteredcomic?.length === 0 ? (
                ...
                <ul className="w-full grid grid-rows-3 gap-2">
