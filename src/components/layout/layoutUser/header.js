          ...
          <div className="w-full h-full">
            {!language ?
              <div>
                ...
                <div className="block sm:hidden">
                  <button className="w-[40px] h-[40px] px-2 bg-gray-50 hover:bg-gray-100 border flex items-center justify-center text-black font-semibold rounded-full" onClick={() =>{ dispatch(getlanguage()); localStorage.setItem("language","en")}}>
                    Eng
                  </button>
                </div>
              ...
              <div>
                ...
                <div className="block sm:hidden">
                  <button className="w-[40px] h-[40px] px-2 bg-gray-50 hover:bg-gray-100 border flex items-center justify-center text-black font-semibold rounded-full" onClick={() =>{ dispatch(getlanguage()); localStorage.setItem("language","kr")}}>
                    Ko
                  </button>
                </div>
