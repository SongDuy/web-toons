                                ...
                                >
                                    {days.map(day => (
                                        <li
                                            ...
                                            className={`max-w-[150px] 3xl:max-w-[220px] h-[60px] uppercase shadow rounded-xl font-semibold text-md cursor-pointer flex items-center justify-center ${currentDay === day ? 'bg-gradient-to-t from-yellow-200 via-yellow-400 to-yellow-500 text-white' : 'bg-white text-black hover:text-yellow-500'}`}
                                        >
                                            {day}
                                        </li>
                                    ))}
                                            ...
                                            >
                                                ...
                                                <div className="absolute inset-0 flex flex-wrap items-center px-3 py-3">
                                                    ...
                                                    <div className="w-full mb-[40px] mr-auto">
                                                        <span className="text-rose-500 rounded-full px-1 gap-1 text-sm font-semibold flex items-center">
                                                            <FavoriteIcon />
                                                            {item.like}
                                                        </span>
