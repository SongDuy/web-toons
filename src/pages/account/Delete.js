  ...
  return (
    <div className="w-full h-full bg-gray-100 py-[40px] flex justify-center items-center">
      <div className="w-[1112px] h-full">
        {/* Tiêu đề */}
        <h1 className="text-[22px] font-semibold">Account Delete</h1>
        ...
        <div className="w-full h-full mt-[15px] px-[155px] py-[80px] bg-white">
          ...
          <div className="w-full mt-[60px] grid grid-cols-1 gap-2">
            <h1 className="text-[18px] font-semibold">Before you go...</h1>
            <ul className="grid grid-cols-1 gap-1">
              <li className="flex flex-wrap">
                <span>
                  &#9679; If you wish to unsubscribe from receiving email
              ...
              <li className="flex flex-wrap">
                <span>
                  &#9679; Any comments you wrote will not be deleted
                  automatically.
                </span>
                <span>
                  &nbsp;&nbsp; Please go to{" "}
            ...
            <div className="w-full mt-[60px] flex gap-3 items-center justify-center">
              ...
              <button
                className={`w-[240px] h-[50px] ${
                  isChecked ? "bg-black" : "bg-gray-200 cursor-not-allowed"
