                        ...
                        <div className="w-full h-[580px] px-3 my-10 custom-scrollbar">
                            <ul className="grid grid-cols-1 gap-2 pb-2">
                                ...
                                <li
                                    ...
                                    className={`w-full h-[50px] cursor-pointer px-5 py-2 shadow flex items-center justify-center rounded ${isTitle === "banners" ? 'text-yellow-500 bg-red-50' : 'hover:text-yellow-500 bg-white'}`}
                                >
                                ...
                                <li
                                    ...
                                    className={`w-full h-[50px] cursor-pointer px-5 py-2 shadow flex items-center justify-center rounded ${isTitle === "censors" ? 'text-yellow-500 bg-red-50' : 'hover:text-yellow-500 bg-white'}`}
                                >
                                ...
                                <li
                                    ...
                                    className={`w-full h-[50px] cursor-pointer px-5 py-2 shadow flex items-center justify-center rounded ${isTitle === "notifications" ? 'text-yellow-500 bg-red-50' : 'hover:text-yellow-500 bg-white'}`}
                                >
                                ...
                                <li
                                    ...
                                    className={`w-full h-[50px] cursor-pointer px-5 py-2 shadow flex items-center justify-center rounded ${isTitle === "reports" ? 'text-yellow-500 bg-red-50' : 'hover:text-yellow-500 bg-white'}`}
                                >
